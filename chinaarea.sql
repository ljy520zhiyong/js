...
Source Database       : chinaarea

Target Server Type    : MYSQL
Target Server Version : 50525
File Encoding         : 65001

Date: 2012-12-05 20:45:04
*/
...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`id`),
  KEY `city_fk` (`city_id`),
  CONSTRAINT `city_fk` FOREIGN KEY (`city_id`) REFERENCES `city` (`cityID`)
...
CREATE TABLE `city` (
  ...
  `province_id` varchar(250) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `province_fk` (`province_id`),
  KEY `cityID` (`cityID`),
  CONSTRAINT `province_fk` FOREIGN KEY (`province_id`) REFERENCES `province` (`provinceID`)
